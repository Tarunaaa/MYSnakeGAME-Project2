...
const foodSound = new Audio('music/eatFood.mp3');
...
function gameEngine(){
    //1st part: updating the snake array & food
    if(isCollid(snakeArr) == true){
        gameOverSound.play();
        musicSound.pause();
        inputDir = {x:0, y:0};
    ...
    // I you have eaten food, increment the score and regenerate food
    ...
    //2nd part: Render(display) the snake and food
